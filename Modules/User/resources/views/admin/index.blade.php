...
function checkedAll() {
    ...
    if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    targets: -3,
                    render: function (data, type, full, meta) {
                        var $membership_number = full['membership_id'];
                        var $status = {
                            1: { title: 'basic', class: 'badge-light-info' },
                            2: { title: 'standard', class: ' badge-light-primary' },
                            3: { title: 'premium', class: ' badge-light-danger' },
                        };
                        if (typeof $status[$membership_number] === 'undefined') {
                            return data;
                        }
                        return (
                            '<span class="badge rounded-pill ' +
                            $status[$membership_number].class +
                            '">' +
                            $status[$membership_number].title +
                            '</span>'
                        );
                    }
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return (
                            ...
                            '<a href="admins/activate/'+data+'" class="dropdown-item">' +
                            ...
                            '</div>'
                                 +
                            '<a href="admins/'+data+'/edit" class="item-edit">' +
        ...
        $('div.head-label').html('<h6 class="mb-0">  اعضاء الادارة</h6>');
    }
    ...
    $('.data-submit').on('click', function () {
        ...
        if ($name != '') {
            ...
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء الييانات بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
