...
@section('content')
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.post.saveNewAdmin') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="number" id="contact-icon"  required class="form-control" name="phone" value="{{old('phone')}}" />
                                        @error('phone')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
