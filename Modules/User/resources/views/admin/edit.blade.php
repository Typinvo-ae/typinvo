...
@section('content')
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('admin.updateAdmin') }}" method="POST" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="fname-icon" class="form-control" value="{{$admin['name']}}" name="name"  />
                                        @error('name')
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="number" id="contact-icon"  required class="form-control" name="phone" value="{{$admin['phone']}}" />
                                        @error('phone')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="email" id="contact-icon" value="{{$admin['email']}}" class="form-control" name="email"  />
                                        @error('email')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                <div class="col-sm-3 text-center">
                                    <label class="col-form-label" for="pass-icon">نوع الاشتراك</label>
                                </div>
                                <div class="col-sm-9">
                                    <div class="input-group-merge">
                                    <select class=" form-select dt-role" id="select2-basic" name="membership_id">
                                        @foreach($memberShips as $memberShip)
                                            <option value="{{$memberShip['id']}}"  @if($memberShip->id==$admin['membership_id'])) selected @endif>{{$memberShip['name']}}</option>
                                        @endforeach
                                   </select>
                                    </div>
                                </div>
