                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{asset('admin/images/pages/forgot-password-v2.svg')}}" alt="Forgot password V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Forgot password-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1"> 🔒نسيت كلمة المرور؟ </h2>
                                <p class="card-text mb-2">قم بادخال البريد الالكترونى وسوف يتم ارسال رسالة بالرابط على بريدك الكترونى</p>
                                    <form class="auth-forgot-password-form mt-2" action="{{ route('forget_password') }}" method="POST" >
                                        ...
                                        {!! csrf_field() !!}
                                        <div class="mb-1">
                                        <label class="form-label" for="forgot-password-email">البريد الالكترونى</label>
                                        <input class="form-control" id="forgot-password-email" type="text" required name="email" placeholder="" aria-describedby="forgot-password-email" autofocus="" tabindex="1" />
                                    </div>
                                    <button class="btn btn-primary w-100" tabindex="2">ارسال رسالة الى البريد الكترونى</button>
                                </form>
