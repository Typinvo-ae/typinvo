...
<head>
    ...
    <meta name="description" content="TYPINVO admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, TYPINVO admin template, dashboard template, flat admin template, responsive admin template, web app">
                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title fw-bold mb-1"> مرحبا بك فى  TYPINVO! 👋</h2>
                            <p class="card-text mb-2">من فضلك قم بتسجيل الدخلو الى حسابك وابدا المغامرة</p>
                            <form class="auth-login-form mt-2" action="{{ route('login.submit') }}" method="post">
                                @csrf
                                @include('common::includes.message')
                                <div class="mb-1">
                                    <label class="form-label" for="login-email">البريد الكترنى</label>
                                    <input class="form-control" id="login-email" type="text" name="email" value="{{@$_COOKIE['USER_EMAIL']}}" placeholder="" aria-describedby="login-email" autofocus="" tabindex="1" />
                                </div>
                                <div class="mb-1">
                                    <div class="d-flex justify-content-between">
                                        <label class="form-label" for="login-password">كلمة المرور</label><a href="{{route('show_forget_password')}}"><small>نسيت كلمة المرور ؟</small></a>
                                    </div>
                                    <div class="input-group input-group-merge form-password-toggle">
                                        <input class="form-control form-control-merge" id="login-password" type="password"  value="******" name="password" placeholder="············" aria-describedby="login-password" tabindex="2" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                    </div>
                                </div>
                                <div class="mb-1">
                                    <div class="form-check">
                                        <input class="form-check-input" id="remember-me" name="remember_me" value="1" checked type="checkbox" tabindex="3" />
