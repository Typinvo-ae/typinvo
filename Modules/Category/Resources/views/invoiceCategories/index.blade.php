...
<div class="row">
           ...
           <a href="{{ route('admin.invoiceMainCategory',1) }}"   >
            ...
            @foreach ($objectCatgoryChildsNames as $key=>$value)
              ...
              <a href="{{ route('admin.viewControlSubCategory',[ $value['department_id'],0]) }}"   >
                  ...
                  <table class="table">
                        ...
                        <div class="col-md-2 col-12">
                            ...
                            <div class="col-md-2 col-12">
                                <div class="mb-1">
                                  ...
                                  تحديد  الخصم (درهم)
                                    ...
                                    <input type="number" class="form-control"  @can('Invoice_discount') @else disabled  @endcan id="discount-{{ $category["id"]; }}" name="discount" onchange="discountFunc(this.value ,{{ $category["id"]; }} ,{{ $category["total"]; }})"   value="0" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                              ...
                              <div   onclick="add_to_cart({{$category['id']}},{{ $category["total"]; }})"  class="btn btn-warning mb-1 waves-effect waves-float waves-light"  >اضافة  للفاتورة   </div>  
...
<script >
  ...
  function totalCountFunc(totalCount,item_id,Total ) {
     ...
     function add_to_cart(item_id,Total) {
    ...
    // console.log(item_id);
     ...
     $.ajax({
        url : '{{ route('admin.addServiceToCart') }}',
        type:"POST",
        data:{
            "_token": "{{ csrf_token() }}",
        ...
        window.location.href = '{{ URL::asset("admin/currentInvoice") }}';
        },
