...
<div class="row">
           <div class="col-md-12 mb-1">
             ...
             <span class="btn btn-info mb-1 waves-effect waves-float waves-light">الرئيسية   </span>
              ...
              <a href="{{ route('admin.categories', $value['department_id']) }}"   >
             <span class="btn btn-info mb-1 waves-effect waves-float waves-light">{{$value['title']}}     </span>
              </a>
              @else

              <a href="{{ route('admin.viewSubDataCategory',  $value['department_id']) }}"   >
             <span class="btn btn-info mb-1 waves-effect waves-float waves-light">{{$value['title']}}    </span>
              </a>
    ...
    <div style="padding-bottom:60px">
               <a href="{{ route('admin.createSubCardCategory') }}"  style="float:left;margin-bottom:10px" >
    ...
    @elseif( $categoryTypecheck1=='true' &&  $categoryTypecheck2=='true' )
        ...
        @if( $categoryTypecheck2=='true')
         <div style="padding-bottom:60px">
        <a href="{{ route('admin.createSubServiceCategory') }}"  style="float:left;margin-left:10px"  >
    ...
    <section id="basic-datatable">
      ...
      <div class="content-overlay"></div>
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <!-- <h3 style="margin-right:15px"> $MainCategory['title']}}  </h3> -->
                <!-- Role cards -->
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
            <div class="card">
                ...
                <h4>   {{$mainCategory['title']}}  </h4>
                    ...
                    <a href="{{ route('admin.viewSubDataCategory', $mainCategory->id) }}" class="d-flex justify-content-between align-items-end mt-1 pt-25" >
                        <div >
                            <div class="role-heading">
                            
                                <a href="{{ route('admin.getEditSubCardCategory', $mainCategory->id) }}" class="role-edit-modal">
                                    <small class="fw-bolder">تعديل  </small>
                                </a>
                                <a href="{{ route('admin.DeleteSubCardCategory', $mainCategory->id) }}" class="role-edit-modal " style="float:left">
                  ...
                  <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.getEditSubServiceCategory',$category['id']) }}"   >
                                  <span class="btn btn-primary mb-1 waves-effect waves-float waves-light">تعديل     </span>
                                    </a>
                       
                                    <a href="{{ route('admin.DeleteSubServiceCategory',$category['id']) }}"   >
