                    ...
                    <div class="row pb-2">
                        ...
                        <div class="col-sm-6 mt-sm-0 mt-2">
                            <table>
                                <tbody>
                                <tr>
                                   <td> <span class="fontCustom" style="margin-left:50px"  >  {{@$ManageInvoice['client_title']}} :</span> <input  style="margin-left:50px"  type="text" class="form-control  " value="{{$orderDetails['user_name']}}"></td>
                                    </tr>
                                    <tr>
                                    <td> <span  class="fontCustom" style="margin-left:50px">    {{@$ManageInvoice['delegate_tax_number']}}:</span> <input   style="margin-left:50px"  type="text" class="form-control " value="{{$orderDetails['tax_number']}}" ></td>
                               </tr>
                                </tbody>
                            </table>
                        </div>
